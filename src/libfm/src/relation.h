...
class RelationJoin {
	public:
		...
		void load(string filename, uint expected_row_count) {
...
void RelationData::load(string filename) {
	...
	cout << "num_cases=" << this->num_cases << "\tnum_values=" << num_values << "\tnum_features=" << this->num_feature << endl;
