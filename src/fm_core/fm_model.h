...
void fm_model::debug() {
	cout << "num_attributes=" << num_attribute << endl;
	cout << "use w0=" << k0 << endl;
	cout << "use w1=" << k1 << endl;
	cout << "dim v =" << num_factor << endl;
	cout << "reg_w0=" << reg0 << endl;
	cout << "reg_w=" << regw << endl;
	cout << "reg_v=" << regv << endl; 
	cout << "init ~ N(" << init_mean << "," << init_stdev << ")" << endl;
}
